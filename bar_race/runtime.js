...
var ge = {
  ...
  element: function(e, t) {
    ...
    var o = pe.hasOwnProperty(r)
      ? document.createElementNS(pe[r], e)
...
function Se(e) {
  (this.tokens = []),
    (this.tokens.links = {}),
    (this.options = e || Re.defaults),
    (this.rules = Ce.normal),
    this.options.gfm &&
      (this.options.tables ? (this.rules = Ce.tables) : (this.rules = Ce.gfm));
}
(Ce.bullet = /(?:[*+-]|\d+\.)/),
  (Ce.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/),
  (Ce.item = Ae(Ce.item, "gm")(/bull/g, Ce.bullet)()),
  (Ce.list = Ae(Ce.list)(/bull/g, Ce.bullet)(
    "hr",
    "\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))"
  )("def", "\\n+(?=" + Ce.def.source + ")")()),
  (Ce.blockquote = Ae(Ce.blockquote)("def", Ce.def)()),
  (Ce._tag =
    "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|[^\\w\\s@]*@)\\b"),
  (Ce.html = Ae(Ce.html)("comment", /<!--[\s\S]*?-->/)(
    "closed",
    /<(tag)[\s\S]+?<\/\1>/
  )("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, Ce._tag)()),
  (Ce.paragraph = Ae(Ce.paragraph)("hr", Ce.hr)("heading", Ce.heading)(
    "lheading",
    Ce.lheading
  )("blockquote", Ce.blockquote)("tag", "<" + Ce._tag)("def", Ce.def)()),
  (Ce.normal = Ue({}, Ce)),
  (Ce.gfm = Ue({}, Ce.normal, {
    fences: /^ *(`{3,}|~{3,})[ \.]*(\S+)? *\n([\s\S]*?)\s*\1 *(?:\n+|$)/,
    paragraph: /^/,
  ...
  (Ce.gfm.paragraph = Ae(Ce.paragraph)(
    "(?!",
    "(?!" +
      Ce.gfm.fences.source.replace("\\1", "\\2") +
      "|" +
      Ce.list.source.replace("\\1", "\\3") +
      "|"
  )()),
  (Ce.tables = Ue({}, Ce.gfm, {
    nptable: /^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/,
...
function Ne(e, t) {
  if (
    ...
    (this.links = e),
    (this.rules = $e.normal),
    (this.renderer = this.options.renderer || new Le()),
  ...
  this.options.gfm
    ? this.options.breaks
      ? (this.rules = $e.breaks)
      : (this.rules = $e.gfm)
    : this.options.pedantic && (this.rules = $e.pedantic);
}
function Le(e) {
  this.options = e || {};
}
...
($e._inside = /(?:\[[^\]]*\]|\\[\[\]]|[^\[\]]|\](?=[^\[]*\]))*/),
  ($e._href = /\s*<?([\s\S]*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/),
  ($e.link = Ae($e.link)("inside", $e._inside)("href", $e._href)()),
  ($e.reflink = Ae($e.reflink)("inside", $e._inside)()),
  ($e.normal = Ue({}, $e)),
  ($e.pedantic = Ue({}, $e.normal, {
    ...
    for (var t, n, r, i, o = ""; e; )
      if ((i = this.rules.escape.exec(e)))
        ...
        if ((i = this.rules.tag.exec(e)))
          ...
          (e = e.substring(i[0].length)),
            (o += this.renderer.codespan(Pe(i[2].trim(), !0)));
          ...
          (e = e.substring(i[0].length)),
            (o += this.renderer.text(Pe(this.smartypants(i[0]))));
        else if (e)
  ...
  (Ne.prototype.outputLink = function(e, t) {
    ...
    return "!" !== e[0].charAt(0)
      ...
      : this.renderer.image(n, r, Pe(e[1]));
  }),
  ...
  (qe.prototype.parse = function(e) {
    (this.inline = new Ne(e.links, this.options, this.renderer)),
...
function Re(e, t, n) {
  if (n || "function" == typeof t) {
    ...
    var r,
      i,
      o = (t = Ue({}, Re.defaults, t || {})).highlight,
      s = 0;
    try {
      r = Se.lex(e, t);
    } catch (e) {
  ...
  return function() {
    return ke(
      function(t) {
        ...
        n.innerHTML = Re(t, { langPrefix: "" }).trim();
        var r = n.querySelectorAll("pre code[class]");
        return (
          r.length > 0 &&
            e(Ie + "highlight.min.js").then(function(t) {
              r.forEach(function(n) {
                ...
                t.getLanguage(n.className)
                  ? r()
                  : e(Ie + "async-languages/index.js")
                      .then(r => {
                        if (r.has(n.className))
                          return e(
                            Ie + "async-languages/" + r.get(n.className)
                          ).then(e => {
...
var ot = st(async function(e, t) {
  ...
  if (
    (n.path && !tt.test(n.path) && (n.path += ".js"),
    n.path && n.version && et.test(n.version))
  )
    return `${Qe}${n.name}@${n.version}/${n.path}`;
  const r = await it(n);
  return `${Qe}${r.name}@${r.version}/${n.path ||
    (function(e) {
      for (const t of nt) {
        const n = e[t];
        if ("string" == typeof n) return tt.test(n) ? n : `${n}.js`;
      }
    })(r) ||
    "index.js"}`;
});
function st(e) {
  ...
  function o(e) {
    return arguments.length > 1
      ? Promise.all(Ye.call(arguments, n)).then(at)
      : n(e);
  }
  return (
    (o.alias = function(t) {
...
function at(e) {
  ...
  for (const n of e)
    for (const e in n)
      Xe.call(n, e) &&
        (null == n[e]
          ? Object.defineProperty(t, e, { get: lt(n, e) })
          : (t[e] = n[e]));
  return t;
}
function lt(e, t) {
...
function mt(e) {
  return function() {
    return Promise.all([
      ...
      e.resolve("@observablehq/katex@0.11.1/dist/katex.min.css").then(ft)
    ]).then(function(e) {
      var t = e[0],
        n = r();
      function r(e) {
        return function() {
          var n = document.createElement("div");
          return (
            t.render(pt.apply(String, arguments), n, e),
...
function bt(e) {
  const t = dt(e);
  Object.defineProperties(this, {
    DOM: { value: ge, writable: !0, enumerable: !0 },
    FileAttachment: { value: he(de), writable: !0, enumerable: !0 },
    Files: { value: be, writable: !0, enumerable: !0 },
    Generators: { value: xe, writable: !0, enumerable: !0 },
    html: { value: he(Ee), writable: !0, enumerable: !0 },
    md: { value: De(t), writable: !0, enumerable: !0 },
    Mutable: { value: he(ze), writable: !0, enumerable: !0 },
    now: { value: Fe, writable: !0, enumerable: !0 },
    Promises: { value: We, writable: !0, enumerable: !0 },
    require: { value: he(t), writable: !0, enumerable: !0 },
    resolve: { value: he(Ve), writable: !0, enumerable: !0 },
    svg: { value: he(ht), writable: !0, enumerable: !0 },
    tex: { value: mt(t), writable: !0, enumerable: !0 },
    width: { value: gt, writable: !0, enumerable: !0 }
  });
}
function vt(e, t) {
...
(vt.prototype = Object.create(Error.prototype)),
  (vt.prototype.name = "RuntimeError"),
...
function Lt(e, t, n) {
  ...
  null == n && (n = Nt),
    Object.defineProperties(this, {
      ...
      _definition: { value: At, writable: !0 },
...
function jt(e, t, n) {
  ...
  if (
    ...
    (this._definition = n),
    (this._value = void 0),
    n === Et ? i._variables.delete(this) : i._variables.add(this),
      ...
      ((s = r.get(e))
        ? s._type === $t
          ...
          : ((s._duplicate = s._definition),
            (this._duplicate = n),
            ((o = new Lt($t, this._module))._name = e),
            (o._definition = this._definition = s._definition = Mt(e)),
...
function Ot(e, t = []) {
  Object.defineProperties(this, {
    ...
    _builtins: {
      value: new Map([["invalidation", Rt], ["visibility", It], ...t])
    },
          ...
          if (!n || n._type !== Ct)
            if (s._definition === kt) {
              ...
              e.import(
                ...
                o,
                t.get(i) ||
                  (i._source ? i._copy(new Ot(e._runtime, e._builtins), t) : i)
              );
    ...
    _resolve: {
      value: function(e) {
        var t,
          n = this._scope.get(e);
        if (!n)
          if (((n = new Lt(St, this)), this._builtins.has(e)))
            n.define(e, xt(this._builtins.get(e)));
...
function Gt(e) {
  ...
  var t = e._value,
    n = ++e._version,
    r = null,
    i = (e._promise = Promise.all(e._inputs.map(Ht))
      .then(function(i) {
        if (e._version === n) {
                ...
                var n = new Promise(function(e) {
                  ...
                  return r.done
                    ...
                    : Promise.resolve(r.value).then(function(r) {
                        if (e._version === t)
                          return Kt(e, r, n).then(i), e._fulfilled(r), r;
                      });
                });
                n.catch(function(r) {
  ...
  Object.defineProperties(Dt.prototype, {
      ...
      value: function() {
        ...
        do {
          for (
            ...
            Gt(t), t._outputs.forEach(r), e.delete(t);
          e.forEach(function(t) {
            zt(t) &&
              (Yt(t, new vt("circular definition")),
              t._outputs.forEach(Bt),
              e.delete(t));
          });
        } while (e.size);
        function r(e) {
    ...
    module: {
      value: function(e, t = Et) {
        let n;
        if (void 0 === e)
          return (n = this._init) ? ((this._init = null), n) : new Ot(this);
...
export { ue as Inspector, bt as Library, Dt as Runtime, vt as RuntimeError };
